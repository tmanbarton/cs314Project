...
function Header(props) {	
	const managerMethods = { bulkAppend: props.placeActions.bulkAppend, setCenter: props.setCenter, removeAll: props.placeActions.removeAll, showMessage: props.showMessage, setTripName: props.setTripName};
	return (
		<Row>
			<Col>
				<h4>	
			...
			<ButtonGroup size="sm" className="button-group">
				...
				{props.places.length && !props.changedTrip ? 
					<TripActions setCenter={props.setCenter} selectedIndex={props.selectedIndex} tripName={props.tripName} disableTour={props.disableTour} distances={props.distances}  places={props.places}  serverSettings={props.serverSettings}  bulkAppend={props.placeActions.bulkAppend} undo={props.placeActions.undo} showMessage={props.showMessage} removeAll={props.placeActions.removeAll} setChangedTrip={props.setChangedTrip} />
				: null}
			</ButtonGroup>
